---
description: Create Codex global rules (AGENTS.md) from codebase analysis
---

# Create AGENTS.md

Generate or replace the project `AGENTS.md` file by analyzing the codebase and extracting patterns.

---

## Objective

Create project-specific global rules that give the coding agent context about:
...
Use `AGENTS.md` and `.codex/reference/` as the target Codex context layer.

**Primary output path**: `AGENTS.md` (project root, for Codex)
...
- On-demand context references in `.codex/reference/`
...
1. Review the generated global rules
2. Add any project-specific notes
3. Remove any sections that don't apply
4. Optionally create or update reference docs in `.codex/reference/`
```
...
- Keep global rules focused and scannable
