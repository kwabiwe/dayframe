...
- Find relevant documentation in docs/, ai_docs/, .codex/reference or ai-wiki if available
...
What follows is a template for you to fill for the implementation agent:
...
**Filename**: `.codex/plans/{kebab-case-descriptive-name}.md`

- Replace `{kebab-case-descriptive-name}` with short, descriptive feature name
- Examples: `add-user-authentication.md`, `implement-search-api.md`, `refactor-database-layer.md`

**Directory**: Create `.codex/plans/` if it doesn't exist
