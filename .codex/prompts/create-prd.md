...
Write the PRD to: `$ARGUMENTS` (recommended: `docs/PRD.md`; default: `docs/PRD.md` if no path is provided)
...
5. Remind the user to read and approve the PRD before implementation planning begins
...
- This prompt contains the complete PRD template structure - no external references needed
