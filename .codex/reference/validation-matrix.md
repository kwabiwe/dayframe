...
47. Large Dynamic Type/no horizontal overflow. On iPhone 11 and the current supported wide phone, compare idle/running cards with empty/long descriptions and zero/one/many/long Quick Actions: shared Play/Stop and Plus centres, equal outer insets, Plus/rail bottom alignment, trailing partial-pill scroll affordance, 44-point targets, unclipped press states, and no card-column translation.
