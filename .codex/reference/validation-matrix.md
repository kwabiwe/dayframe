...
- Enter Tags with Add a tag and typed `#`, then delete the only `#`. Require continuous Description focus/keyboard, a closed Tags panel and no empty Suggestions reopen. Type matching text afterward and require the existing live Suggestions ranking to return.
