...
- Field-like web controls reserve one stable two-pixel perimeter and use the neutral `control-border` treatment on keyboard focus; they do not add a second offset outline or shift layout. Standalone actions retain the semantic blue focus ring.
