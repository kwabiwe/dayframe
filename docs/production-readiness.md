...
As of 2026-07-14, the active internal TestFlight lane has verified build `0.1.0 (36)` in `Internal Health Debug`. The product is usable for owner testing, but several areas remain `Watch`, `Planned`, or `Future` in `docs/feature-fix-tracker.md`.
