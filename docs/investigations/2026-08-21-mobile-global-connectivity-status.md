...
| --- | --- |
| Focused monitor/recovery/presentation/Settings diagnostics tests | PASS: 6 files / 62 tests, including repeated unchanged NetInfo evidence after HTTP-forced Offline, stale forced-retry cancellation, offline diagnostics access, combined attention copy, and behavioural Retry/Discard actions |
| Complete mobile suite | PASS: 88 files / 862 tests |
| Mobile and full workspace typecheck | PASS |
