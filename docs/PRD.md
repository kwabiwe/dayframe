...
Current reality as of 2026-07-12: Dayframe is in an active internal TestFlight lane, with build `0.1.0 (28)` verified for KB testing. The tracker in `docs/feature-fix-tracker.md` is the source of truth for what is `Done`, still under `Watch`, or planned next.
...
- ✅ Internal TestFlight build workflow is active and verified through `0.1.0 (28)`.
